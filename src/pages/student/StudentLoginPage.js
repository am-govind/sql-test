      ...
      <div class="space-y-4 px-6 py-6">
        ...
        <form id="student-login-form" class="space-y-3">
          <label class="block">
            ...
            <input id="input-identifier" type="text" required class="mt-1 w-full px-3 py-2 text-sm" autocomplete="username" />
          </label>
          <label class="block">
            <span class="text-xs font-bold uppercase tracking-wide text-bolt-muted">Date of birth</span>
            <input id="input-dob" type="date" required class="mt-1 w-full px-3 py-2 text-sm" autocomplete="bday" />
          </label>
